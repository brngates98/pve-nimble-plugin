...
| **Subnets (auto iSCSI)**           | GET `subnets`                                                                                      | Read; discovery_ip, allow_iscsi, type                                                                                                                                                                        | OK; `nimble_data_as_list` unwraps `data.items[]`; optional storage `iscsi_discovery_ips` merges with API addresses.                |
